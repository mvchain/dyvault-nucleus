...
import com.mvc.dyvault.console.dao.BlockTransactionMapper;
        ...
        for (String idStr : idArr) {
            ...
            if (null != blockTransaction) {
                ...
                if (dBlockStatusDTO.getStatus() == 2) {
                    ...
                    appUserBalanceService.updateBalance(blockTransaction.getUserId(), blockTransaction.getTokenId(), BigDecimal.valueOf(token.getFee()));

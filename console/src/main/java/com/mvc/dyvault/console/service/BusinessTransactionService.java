...
public class BusinessTransactionService extends AbstractService<BusinessTransaction> implements BaseService<BusinessTransaction> {
    ...
    public ToPayResponse createOrder(ToPayEntity toPayEntity) {
        ...
        dto.setPrice(price.getTokenPrice());
        ...
        dto.setTokenValue(toPayEntity.getCny().divide(price.getTokenPrice().multiply(BigDecimal.ONE.add(BigDecimal.valueOf(supplier.getPriceDifferences() / 100))), 6, RoundingMode.DOWN));
